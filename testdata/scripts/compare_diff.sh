TEST_NAME="compare tree after delete"
# TEST_NAME="compare n"
...
zig test src/clibart.zig --c-source libartc/src/art.c -I/usr/include/ -I/usr/include/x86_64-linux-gnu/ -lc -I \
    libartc/src -I. --test-filter "$TEST_NAME" -DLANG="'z'" 2> testdata/z.txt
zig test src/clibart.zig --c-source libartc/src/art.c -I/usr/include/ -I/usr/include/x86_64-linux-gnu/ -lc -I \
    libartc/src -I. --test-filter "$TEST_NAME" -DLANG="'c'" 2> testdata/c.txt
